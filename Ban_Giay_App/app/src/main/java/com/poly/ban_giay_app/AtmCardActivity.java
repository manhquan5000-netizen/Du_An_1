...
public class AtmCardActivity extends AppCompatActivity {
    ...
    private long parsePrice(String priceString) {
        ...
        try {
            ...
            android.util.Log.e("AtmCardActivity", "Error parsing price: " + priceString, e);
            return 0;
        }
    }
    ...
    private void setupBottomNavigation() {
        ...
        if (navHome != null) {
            navHome.setOnClickListener(v -> {
                Intent intent = new Intent(AtmCardActivity.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            });
        ...
        if (navCategories != null) {
            navCategories.setOnClickListener(v -> {
                Intent intent = new Intent(AtmCardActivity.this, CategoriesActivity.class);
                startActivity(intent);
            });
        }
        ...
        if (navHelp != null) {
            navHelp.setOnClickListener(v -> {
                Intent intent = new Intent(AtmCardActivity.this, HelpActivity.class);
                startActivity(intent);
            });
        }
        ...
        if (navAccount != null) {
            navAccount.setOnClickListener(v -> {
                if (sessionManager.isLoggedIn()) {
                    Intent intent = new Intent(AtmCardActivity.this, AccountActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(AtmCardActivity.this, LoginActivity.class);
                    startActivity(intent);
                }
            });
        }
